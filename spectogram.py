...
class MainApp():
    ...
    def window(self,master):
        ...
        self.save_button = tk.Button(master, text="Zapisz obraz", command=self.save_fig)
    ...
    def save_fig(self):
        wamp_file = "wamp.png"
        spect_file = "spect.png"
        self.wamp.savefig(wamp_file, dpi=100)
        self.Wspectogram.savefig(spect_file, dpi=100)
